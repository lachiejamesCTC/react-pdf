...
## How to install
```sh
yarn add @lachie-pdf/render
```

## How it works

```js
const render = require('@lachie-pdf/render');
const primitives = require('@lachie-pdf/primitives');
...
Mandatory field specifiying the type of the particular node. The full list of types can be found and imported from `@lachie-pdf/primitives`
...
const fs = require('fs');
const render = require('@lachie-pdf/render');
const pdfkit = require('@lachie-pdf/pdfkit');
